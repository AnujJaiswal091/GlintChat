  ...
  return (
    <div className="w-[100%] h-[100%] flex items-center gap-24">
      ...
      <div className="flex-1 flex flex-col items-center gap-5">
        ...
        >
          <input
            className="p-5 border-none outline-none bg-[rgba(17,25,40,0.6)] text-white rounded-lg"
            type="text"
            placeholder="Email"
            name="email"
          />
          ...
          <button
            disabled={loading}
            className="w-[100%] disabled:cursor-not-allowed disabled:bg-blue-900 p-5 border-none bg-blue-700 text-white rounded-lg cursor-pointer font-semibold hover:bg-blue-800  active:bg-blue-900"
            type="submit"
          >
      ...
      <div className="h-[80%] w-[2px] bg-gray-600"> {/* Separator */}</div>
      <div className="flex-1 flex flex-col items-center gap-5">
        {/* Item */}
