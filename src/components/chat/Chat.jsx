        ...
        <div className='flex flex-col flex-[2] border-l-[1px] border-r-[1px] border-gray-600 h-full'>
            ...
            <div className='p-5 flex items-center justify-between border-b-[1px] border-gray-600'>
                ...
                <div className='flex items-center gap-5'>
                    {/* User */}
                    <img className='h-14 w-14 rounded-full object-cover' src={user?.avatar || "./avatar.png"} alt="" />
    ...
    message.senderId === currentUser.id ? (
        ...
        >   
            <div>
                ...
                <span className='text-sm text-gray-400'>{format(message.createdAt.toDate())}</span>
            </div>
        </div>
    ) : (
        ...
        >
            ...
            <div className='flex items-center justify-between p-5 gap-5 border-t-[1px] border-gray-600 mt-auto'>
                ...
                <button onClick={handleSend} className='bg-blue-500 rounded-lg py-2 px-5 border-none disabled:cursor-not-allowed' disabled={isCurrentUserBlocked || isReceiverBlocked}>
                    Send
                </button>
            </div>
        </div>
